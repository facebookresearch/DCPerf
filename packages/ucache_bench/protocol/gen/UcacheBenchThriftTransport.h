...
#include "cea/chips/benchpress/packages/ucache_bench/protocol/gen/gen-cpp2/UcacheBenchAsyncClient.h"

namespace facebook {
namespace memcache {

template <>
class ThriftTransportMethods<ucachebench::UcacheBenchRouterInfo> : public ThriftTransportUtil {
 public:
  ThriftTransportMethods() = default;
  virtual ~ThriftTransportMethods() override = default;

folly::Try<apache::thrift::RpcResponseComplete<ucachebench::UcbDeleteReply>> sendSyncHelper(
    typename ucachebench::UcacheBenchRouterInfo::RouteHandleAsyncClient* thriftClient,
    const ucachebench::UcbDeleteRequest& request,
    apache::thrift::RpcOptions& rpcOptions,
    RpcStatsContext* rpcStatsContext = nullptr) {
  bool needServerLoad = mcrouter::fiber_local<ucachebench::UcacheBenchRouterInfo>::getThriftServerLoadEnabled();
...
#endif
  auto reply = thriftClient->sync_complete_ucbDelete(
...
folly::Try<apache::thrift::RpcResponseComplete<ucachebench::UcbGetReply>> sendSyncHelper(
    typename ucachebench::UcacheBenchRouterInfo::RouteHandleAsyncClient* thriftClient,
    const ucachebench::UcbGetRequest& request,
    apache::thrift::RpcOptions& rpcOptions,
    RpcStatsContext* rpcStatsContext = nullptr) {
  bool needServerLoad = mcrouter::fiber_local<ucachebench::UcacheBenchRouterInfo>::getThriftServerLoadEnabled();
  if (FOLLY_UNLIKELY(needServerLoad)) {
  ...
  traceRequest(request, rpcOptions);
#endif
  auto reply = thriftClient->sync_complete_ucbGet(
      std::move(rpcOptions), request);
  if (rpcStatsContext && reply.hasValue()) {
      auto& stats = reply->responseContext.rpcTransportStats;
      rpcStatsContext->requestBodySize = stats.requestSerializedSizeBytes;
...
folly::Try<apache::thrift::RpcResponseComplete<ucachebench::UcbSetReply>> sendSyncHelper(
    typename ucachebench::UcacheBenchRouterInfo::RouteHandleAsyncClient* thriftClient,
    const ucachebench::UcbSetRequest& request,
    apache::thrift::RpcOptions& rpcOptions,
    RpcStatsContext* rpcStatsContext = nullptr) {
  bool needServerLoad = mcrouter::fiber_local<ucachebench::UcacheBenchRouterInfo>::getThriftServerLoadEnabled();
  if (FOLLY_UNLIKELY(needServerLoad)) {
  ...
  traceRequest(request, rpcOptions);
#endif
  auto reply = thriftClient->sync_complete_ucbSet(
      std::move(rpcOptions), request);
  if (rpcStatsContext && reply.hasValue()) {
      auto& stats = reply->responseContext.rpcTransportStats;
      rpcStatsContext->requestBodySize = stats.requestSerializedSizeBytes;
...
folly::Try<apache::thrift::RpcResponseComplete<McVersionReply>> sendSyncHelper(
 ...
 protected:
  std::optional<apache::thrift::Client<facebook::ucachebench::thrift::UcacheBench>> thriftClient_;
};

template <>
class ThriftTransport<ucachebench::UcacheBenchRouterInfo> : public ThriftTransportMethods<ucachebench::UcacheBenchRouterInfo>,
 ...
 public:
  ...
  ucachebench::UcbDeleteReply sendSync(
      const ucachebench::UcbDeleteRequest& request,
    ...
    return sendSyncImpl([this, &request, timeout, rpcStatsContext] {
      ...
      if (FOLLY_LIKELY(thriftClient != nullptr)) {
        ...
        return folly::Try<apache::thrift::RpcResponseComplete<ucachebench::UcbDeleteReply>>(
  ...
  ucachebench::UcbGetReply sendSync(
      const ucachebench::UcbGetRequest& request,
      std::chrono::milliseconds timeout,
      RpcStatsContext* rpcStatsContext = nullptr) {
    ...
    return sendSyncImpl([this, &request, timeout, rpcStatsContext] {
      ...
      if (FOLLY_LIKELY(thriftClient != nullptr)) {
        ...
        return folly::Try<apache::thrift::RpcResponseComplete<ucachebench::UcbGetReply>>(
            folly::make_exception_wrapper<apache::thrift::transport::TTransportException>(
              apache::thrift::transport::TTransportException::NOT_OPEN,
              "Error creating thrift client."));
      }
  ...
  ucachebench::UcbSetReply sendSync(
      const ucachebench::UcbSetRequest& request,
      std::chrono::milliseconds timeout,
      RpcStatsContext* rpcStatsContext = nullptr) {
    ...
    return sendSyncImpl([this, &request, timeout, rpcStatsContext] {
      ...
      if (FOLLY_LIKELY(thriftClient != nullptr)) {
        ...
        return folly::Try<apache::thrift::RpcResponseComplete<ucachebench::UcbSetReply>>(
            folly::make_exception_wrapper<apache::thrift::transport::TTransportException>(
              apache::thrift::transport::TTransportException::NOT_OPEN,
              "Error creating thrift client."));
      }
 ...
 private:
  apache::thrift::Client<facebook::ucachebench::thrift::UcacheBench>* getThriftClient() {
    if (FOLLY_UNLIKELY(!thriftClient_)) {
      thriftClient_ = createThriftClient<apache::thrift::Client<facebook::ucachebench::thrift::UcacheBench>>();
    }
