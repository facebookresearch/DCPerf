...
class UcacheBenchJsonClient : public JsonClient {
 public:
  explicit UcacheBenchJsonClient(
 ...
 protected:
  bool sendRequestByName(
    ...
    if (requestName == facebook::ucachebench::UcbDeleteRequest::name) {
      return sendRequest<facebook::ucachebench::UcbDeleteRequest>(requestJson, replyJson);
    }
    if (requestName == facebook::ucachebench::UcbGetRequest::name) {
      return sendRequest<facebook::ucachebench::UcbGetRequest>(requestJson, replyJson);
    }
    if (requestName == facebook::ucachebench::UcbSetRequest::name) {
      return sendRequest<facebook::ucachebench::UcbSetRequest>(requestJson, replyJson);
    }
    return false;
  }
};
...
int main(int argc, char** argv) {
  ...
  client.sendRequests<UcacheBenchJsonClient>(argc, const_cast<const char**>(argv));
  return 0;
}
