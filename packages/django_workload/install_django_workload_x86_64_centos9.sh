...
if ! [ -d Python-3.14.2 ]; then
    ...
    # Skip test_generators during PGO profiling — test_raise_and_yield_from
    # fails on some x86 microarchitectures (Cooper Lake, Turin) due to
    # signal handling timing differences. The test works fine at runtime.
