...
# - High impact (>1.5%): weight = 10
# - Medium-high impact (1.0%-1.5%): weight = 7
# - Medium impact (0.5%-1.0%): weight = 5
# - Low-medium impact (0.3%-0.5%): weight = 3
# - Low impact (<0.3%): weight = 1
#
...
REELS_TRAY_PRIMITIVE_WEIGHTS = {
    # Profile 1: ML Pipeline Response Building (18.25%)
    ...
    # Profile 14: Laser Service (1.49%)
    "laser_multiget_batch": 10,
    "laser_client_cache_lookup": 5,
    "laser_async_get_chain": 5,
    ...
    # Profile 20: QE2 Resolver (0.89%)
    "qe2_override_generation": 5,
    "qe2_default_params": 2,
    "qe2_param_generation": 2,
    # Profile 21: QE2 Gating Utils (0.89%)
    "qe2_gk_check": 5,
    "qe2_gk_restraint_validation": 2,
    "qe2_gk_async_check": 2,
    # Profile 22: Node User Property Access (0.79%)
    "user_property_access": 5,
    "is_private_impl": 2,
    "generated_base_property_lookup": 2,
    # Profile 23: Gatekeeper Util (0.79%)
    "gk_restraint_context_conversion": 5,
    "gk_percent_value_calculation": 2,
    "gk_context_caching": 2,
    # Profile 24: GK Restraint Context (0.79%)
    "gk_restraint_context_init": 5,
    "gk_request_default_context_init": 2,
    "gk_async_check": 2,
...
def inject_primitives_into_run(class_code: str, variant_id: int) -> str:
    ...
    for _ in range(num_operations):
        # 60% chance of CPU primitive, 40% chance of RPC call
...
def format_reels_tray_primitive_calls(
    ...
    primitive_class_map = {
        # Profile 1: ML Pipeline primitives (18.25%)
        ...
        # Profile 2: Experiment primitives (9.13%)
        ...
        # Profile 4 & 5: Feature flag primitives (10.12%)
        ...
        # Profile 6: Config primitives (2.88%)
        ...
        # Profile 8: Metrics primitives (2.18%)
        ...
        # Profile 9: Cache primitives (2.18%)
        ...
        # Profile 12: Privacy Zone Flow primitives (1.69%)
        ...
        # Profile 13: Call Stack primitives (1.49%)
        ...
        # Profile 14: Laser Service primitives (1.49%)
        "laser_multiget_batch": "LaserServiceOperationsPrimitives.primitive_laser_multiget_batch",
        "laser_client_cache_lookup": "LaserServiceOperationsPrimitives.primitive_laser_client_cache_lookup",
        "laser_async_get_chain": "LaserServiceOperationsPrimitives.primitive_laser_async_get_chain",
        # Profile 16: URL Generation primitives (1.39%)
        ...
        # Profile 17: Policy Memoization primitives (1.29%)
        ...
        # Profile 18: Privacy Zone Environment primitives (0.99%)
        ...
        # Profile 19: GraphQL Execution primitives (0.99%)
        ...
        # Profile 20: QE2 Resolver primitives (0.89%)
        "qe2_override_generation": "QE2ResolverPrimitives.primitive_qe2_override_generation",
        "qe2_default_params": "QE2ResolverPrimitives.primitive_qe2_default_params",
        "qe2_param_generation": "QE2ResolverPrimitives.primitive_qe2_param_generation",
        # Profile 21: QE2 Gating Utils primitives (0.89%)
        "qe2_gk_check": "QE2GatingUtilsPrimitives.primitive_qe2_gk_check",
        "qe2_gk_restraint_validation": "QE2GatingUtilsPrimitives.primitive_qe2_gk_restraint_validation",
        "qe2_gk_async_check": "QE2GatingUtilsPrimitives.primitive_qe2_gk_async_check",
        # Profile 22: Node User Property primitives (0.79%)
        "user_property_access": "NodeUserPropertyPrimitives.primitive_user_property_access",
        "is_private_impl": "NodeUserPropertyPrimitives.primitive_is_private_impl",
        "generated_base_property_lookup": "NodeUserPropertyPrimitives.primitive_generated_base_property_lookup",
        # Profile 23: Gatekeeper Util primitives (0.79%)
        "gk_restraint_context_conversion": "GatekeeperUtilPrimitives.primitive_gk_restraint_context_conversion",
        "gk_percent_value_calculation": "GatekeeperUtilPrimitives.primitive_gk_percent_value_calculation",
        "gk_context_caching": "GatekeeperUtilPrimitives.primitive_gk_context_caching",
        # Profile 24: GK Restraint Context primitives (0.79%)
        "gk_restraint_context_init": "GKRestraintContextPrimitives.primitive_gk_restraint_context_init",
        "gk_request_default_context_init": "GKRestraintContextPrimitives.primitive_gk_request_default_context_init",
        "gk_async_check": "GKRestraintContextPrimitives.primitive_gk_async_check",
        # Profile 25: Zone Info primitives (0.69%)
        ...
        # Profile 26: Zone Evaluators primitives (0.69%)
        ...
        # Profile 28: Shared Cache primitives (0.69%)
        ...
        # Profile 29: Latency Collector primitives (0.69%)
        ...
        # Profile 30: Asyncio Helper primitives (0.69%)
...
def format_inbox_primitive_calls(
    ...
    # Map primitive names to their class methods
    primitive_class_map = {
        # Profile 3: Experimentation primitives (4.2%)
        ...
        # Profile 5: Memoization primitives (2.2%)
        ...
        # Profile 8: Feature Gating primitives (2.0%)
        ...
        # Profile 9: Schema Validation primitives (1.8%)
        ...
        # Profile 10: Metrics Collection primitives (1.7%)
        ...
        # Profile 11: Config Construction primitives (1.68%)
        ...
        # Profile 12: Property Access primitives (1.59%)
        ...
        # Profile 14: Type Caching primitives (1.50%)
        ...
        # Profile 15: Viewer Context primitives (1.50%)
        ...
        # Profile 21: Experiment Resolution primitives (1.24%)
        ...
        # Profile 25: Feature Flags primitives (0.97%)
        ...
        # Profile 27: Notification Rendering primitives (0.80%)
