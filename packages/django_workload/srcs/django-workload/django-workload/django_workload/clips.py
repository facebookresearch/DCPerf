...
This file provides clip handler variants, each calling a different service
variant with pre-permuted CPU primitives for I-cache pressure simulation.
"""
...
class Clips:
    """
    Clips endpoint handler (base variant).
