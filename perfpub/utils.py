...
def process_metrics(
    ...
    Map = {
        ...
        "TMA_Frontend_Bound(%)": "frontend_bound",
        ...
        "TMA_..Branch_Mispredicts(%)": "branch_mispred",
        ...
        "L1-I code read misses (w/ prefetches) per instr": "L1_icache_mpki",
        ...
        "L1D MPI (includes data+rfo w/ prefetches)": "L1_dcache_mpki",
        ...
        "L2 MPI (includes code+data+rfo w/ prefetches)": "L2_cache_mpki",
        "LLC MPKI": "LLC_mpki",
        ...
        "LLC MPI (includes code+data+rfo w/ prefetches)": "LLC_mpki",
        "L3 MPKI": "LLC_mpki",
        "iTLB MPKI": "iTLB_mpki",
        ...
        "TMA_Bad_Speculation(%)": "bad_speculation",
        ...
        "L2 demand code MPI": "L2_code_mpki",
        "L2 Cache Miss from IC Fill Miss PKI": "L2_code_mpki",
        "L2 Data MPKI": "L2_data_mpki",
        "metric_L2 demand data read MPI": "L2_data_mpki",
        "L2 demand data read MPI": "L2_data_mpki",
    }
