...
"""AMD Zen5 engineering sample -- core PMU + DRAM/CXL bandwidth"""
...
try:
    from cea.chips.benchpress.perfutils.amd_perf.metrics import (
        ...
        zen5es_total_cxl_read_bw_mbs,
        zen5es_total_cxl_write_bw_mbs,
    )
except ModuleNotFoundError:  # standalone / OSS: run from perfutils/ dir
...
register_arch(
    ...
    vendor="amd",
    align="longest",
    description="Zen5 engineering sample -- core PMU + DRAM/CXL bandwidth",
)
